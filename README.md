...
| Skill | What it does |
| --- | --- |
| [`anonymize-sensitive-data`](skills/anonymize-sensitive-data/SKILL.md) | Removes unnecessary sensitive data from responses and downstream inputs. Preserves exact values when the authorized task requires them. |
